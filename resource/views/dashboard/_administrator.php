...
<section class="dashboard-counts section-padding">
  <div class="container-fluid">
    <div class="row text-white">
      ...
      <div class="col-sm-3">
        <div class="small-box bg-primary" id="boxkelas">
          <div class="inner">
            <?php
              $db->table('kelas')->get();
              echo '<h3>'.$db->num_rows().'</h3>';
      ...
      <div class="col-sm-3">
        <div class="small-box bg-primary" id="boxmapel">
          <div class="inner">
            <?php
              $db->table('mapel')->get();
              echo '<h3>'.$db->num_rows().'</h3>';
      ...
      <div class="col-sm-3">
        <div class="small-box bg-primary" id="boxkbm">
          <div class="inner">
            <?php
              $db->table('kbm')->get();
              echo '<h3>'.$db->num_rows().'</h3>';
      ...
      <div class="col-sm-3">
        <div class="small-box bg-primary" id="boxpetugas">
          <div class="inner">
            <?php
...
<script type="text/javascript">
  $(document).ready( function() {
    ...
    $('#boxmapel').click( function() {
      $('#menupage').load('resource/views/mapel/_home.php', {page: '<?= token(32); ?>'});
      $('.menuActive').removeClass('active');
      $('.pageRemove').remove();
    ...
    $('#boxkelas').click( function() {
      $('#menupage').load('resource/views/kelas/_home.php', {page: '<?= token(32); ?>'});
      $('.menuActive').removeClass('active');
      $('.pageRemove').remove();
      $('#Ackelas').addClass('active');
      changeurl('kelas.php');
    });
    $('#boxkbm').click( function() {
      $('#menupage').load('resource/views/kbm/_home.php', {page: '<?= token(32); ?>'});
      $('.menuActive').removeClass('active');
      $('.pageRemove').remove();
      $('#Ackbm').addClass('active');
      changeurl('kbm.php');
    });
    $('#boxpetugas').click( function() {
      $('#menupage').load('resource/views/petugas/_home.php', {page: '<?= token(32); ?>'});
      $('.menuActive').removeClass('active');
      $('.pageRemove').remove();
